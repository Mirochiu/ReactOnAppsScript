...
const AdminPage = () => {
  ...
  useEffect(() => {
    if (barRef.current) {
      InitBar(barRef.current);
    }
  }, [barRef]);
  return (
    <main>
      <div className="container-fluid px-4">
        <h1 className="mt-4">儀表板</h1>
        <ol className="breadcrumb mb-4">
          <li className="breadcrumb-item active">
            您可以在這裡管理與追蹤您的客戶與商品狀態
          </li>
        </ol>
        <div className="row">
          <div className="col-xl-3 col-md-6">
            <div className="card bg-primary text-white mb-4">
              <div className="card-body">系統訊息</div>
          ...
          <div className="col-xl-3 col-md-6">
            <div className="card bg-warning text-white mb-4">
              <div className="card-body">提醒訊息</div>
              <div className="card-footer d-flex align-items-center justify-content-between">
                <a className="small text-white stretched-link" href="#">
                  查看細節
                </a>
          ...
          <div className="col-xl-3 col-md-6">
            <div className="card bg-success text-white mb-4">
              <div className="card-body">成交訊息</div>
              <div className="card-footer d-flex align-items-center justify-content-between">
                <a className="small text-white stretched-link" href="#">
                  查看細節
                </a>
          ...
          <div className="col-xl-3 col-md-6">
            <div className="card bg-danger text-white mb-4">
              <div className="card-body">警告訊息</div>
              <div className="card-footer d-flex align-items-center justify-content-between">
                <a className="small text-white stretched-link" href="#">
                  查看細節
                </a>
        ...
        <div className="row">
          ...
          <div className="col-xl-6">
            <div className="card mb-4">
              ...
              <div className="card-body">
                <canvas ref={barRef} width="100%" height="40"></canvas>
              </div>
            </div>
          </div>
        </div>
