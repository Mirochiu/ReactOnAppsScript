import { SERVER_URL, FAVICON_URL } from './settings';

export const postProc = (evaluatedTemplate) => {
  if (FAVICON_URL) {
    evaluatedTemplate.setFaviconUrl(FAVICON_URL);
  }
...
const defaultPage = () =>
  postProc(HtmlService.createTemplateFromFile('web-demo-bootstrap.html').evaluate());
